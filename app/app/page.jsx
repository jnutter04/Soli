...
import { useState, useEffect, useMemo, useRef, useId, Children, isValidElement, cloneElement } from "react";
import { useRouter } from "next/navigation";
import {
  LayoutDashboard, PlusCircle, Users, Package, Settings as SettingsIcon, Calculator,
  AlertTriangle, Bell, Trash2, Sun, LogOut, Moon, CalendarDays, Gift, Receipt, MoreHorizontal
} from "lucide-react";
...
/* The active display symbol, kept here as well because a dozen labels read it
   directly inside template strings. setDisplayCurrency hands back the symbol it
   just stored, so this copy and the one behind money() can never disagree. */
let CUR = "$";
...
function SoliApp() {
  ...
  CUR = setDisplayCurrency(settings.currency); // keep money() in the user's chosen currency
